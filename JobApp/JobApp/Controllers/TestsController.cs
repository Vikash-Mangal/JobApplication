...
namespace JobApp.Controllers
{
    public class TestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Contact")] Test test)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Contact")] Test test)
        {
            if (id != test.Id)
            {
                return NotFound();
